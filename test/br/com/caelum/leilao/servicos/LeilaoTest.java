...
public class LeilaoTest {
	...
	@Test
	public void deveCriarUmLanceComODobroDoAnteriorDadoPorEsseUsuario() {
		...
		leilao.dobraLance(new Lance(steveJobs, 0));

		assertEquals("Steve Jobs", leilao.getLances().get(leilao.getLances().size()-1).getUsuario().getNome());	
		assertEquals(8000.0, leilao.getLances().get(leilao.getLances().size()-1).getValor(), 0.00001);
	}
	
	@Test
	public void naoDeveCriarUmLanceComODobroDoAnteriorDadoPorEsseUsuarioSeEleJaDera5Lances() {
	...
	@Test
	public void naoDeveCriarUmLanceComODobroDoAnteriorDadoPorEsseUsuarioSeEsseEhOsegundoSeguido() {
